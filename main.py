...
class GameLearning:
    ...
    def train_rl_vs_ai(self, episodes=1000, render=False, save_interval=100):
        ...
        plot_agent_reward(rewards, 
                         ...
                         save_path=f"{self.figures_dir}/rewards_rl_vs_ai.png")
    ...
    def train_rl_vs_human(self, episodes=100, render=True):
        ...
        plot_agent_reward(rewards,
                         ...
                         save_path=f"{self.figures_dir}/rewards_rl_vs_human.png")
    ...
    def train_rl_vs_rl(self, episodes=1000, render=False, save_interval=100):
        ...
        plt.tight_layout()
        plt.savefig(f"{self.figures_dir}/rewards_rl_vs_rl.png", dpi=150, bbox_inches='tight')
        plt.show()
...
def main():
    ...
    print("=" * 60)
    print("ATELIER 4: Q-LEARNING PONG")
    print("Université Abdelmalek Essaadi - FST Tanger")
    print("Machine Learning - LSI S3 - 2025/2026")
    print("=" * 60)
    ...
    if choice == '1':
        ...
        plot_training_comparison(
            ...
            save_path=f"{trainer.figures_dir}/comparison_all_modes.png"
        )
